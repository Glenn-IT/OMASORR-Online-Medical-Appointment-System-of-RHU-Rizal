...
CREATE TABLE `consultation_records` (
  ...
  `folder_no` varchar(50) DEFAULT NULL,
  ...
  `pertinent_pe` text DEFAULT NULL,
  `diagnosis` text DEFAULT NULL,
  `treatment` text DEFAULT NULL,
  `lab_findings` text DEFAULT NULL,
...
(6, 'patient', 11, '$2y$10$6TgHDtQZ8MqAj843r69l7e0HrPp7XBRqAoRKToiOokgWlBesvo6V6', 0, '2026-08-25 01:50:45', NULL, '2026-08-25 01:40:45'),
(7, 'patient', 11, '$2y$10$9O0xLiu0Zl92UGgTuU0KyeUdWeRuQ7s2Ax5iml5vCg86jxZUdPBAq', 0, '2026-09-15 03:01:09', '2026-09-15 02:51:39', '2026-09-15 02:51:09');
...
--
ALTER TABLE `consultation_records`
  ADD CONSTRAINT `fk_consultation_appointment` FOREIGN KEY (`appointment_id`) REFERENCES `appointments` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_consultation_doctor` FOREIGN KEY (`doctor_id`) REFERENCES `doctors` (`id`) ON DELETE SET NULL,
