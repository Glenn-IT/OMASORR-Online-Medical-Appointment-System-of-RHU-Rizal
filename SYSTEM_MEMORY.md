...
| `openModal(id)` / `closeModal(id)` | [`assets/js/app.js`](file:///C:/xampp/htdocs/rhu-appointment-system/assets/js/app.js) | Manages modal overlay visibility & body scroll locks. | Status change modals, Add Doctor modals, cancel dialogs, logout confirmation modal. |
